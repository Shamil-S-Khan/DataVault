        ...
        return (
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Fitness Score</p>
                </div>
            </div>
        )
    }
            ...
            <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-sm font-bold ${getGradeColor(fitness.grade)}`}>
                            Grade: {fitness.grade}
                        </span>
                    </div>
                            ...
                            return (
                                <div key={key} className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className={`text-sm font-bold ${dimColors.text}`}>
                                            {value}/10
                                        </span>
                                    </div>
